...
def register_ascend_postproc(func: Callable[[str, Target], str], override: bool = True):
    ...
    Args:
        ...
        override: Whether to override existing registered function. Defaults to True.
    """
    register_func("tilelang_callback_ascend_postproc", f=func, override=override)
...
def register_ascend_postproc_callback(func: Union[Callable, bool] = None, override: bool = True):
    """Decorator for registering ascend post-processing callback function.
