...
void main_kernel( GM_ADDR INPUT_handle,  GM_ADDR OUTPUT_handle) {
  ...
  AscendC::WaitFlag<AscendC::HardEvent::MTE2_V>(0);
  {
    ...
    tl::ascend::elementwise_unary<float, 128 * 128, 0>(ubIn_[0], ubOut_[0]);
  ...
  {
    auto ubOut_ = ubOut.Get<float>();
    tl::ascend::copy_ub_to_gm<float, 128, 128, 128, 128>(OUTPUT[0], ubOut_[0]);
  }
}
